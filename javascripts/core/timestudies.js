...
function updateTheoremButtons() {
  ...
  document.getElementById("theoremam").innerHTML = "购买时间定律 <br>成本: "+shortenCosts(player.timestudy.amcost)+" 反物质"
	...
	document.getElementById("timetheorems").innerHTML = "你拥有 <span style='display:inline' class=\"TheoremAmount\">"+(player.timestudy.theorem>99999?shortenMoney(player.timestudy.theorem):getFullExpansion(Math.floor(player.timestudy.theorem)))+"</span> 时间定律。 "
}
