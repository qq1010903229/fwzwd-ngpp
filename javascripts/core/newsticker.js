...
["饼干是个谎言。", true, "a1"], ["反物质饼干已经被证实不存在，无论谁声称它，请停止。", true, "a4"], ["Antimatter ghosts do not exist. Just like matter ghosts. They don't have any matter, for that matter.", true, "a2"],
...
["Alright -Alright", true, "a19"], ["英语问候语不存在于反物质说话。", true, "a20"], ["要购买max或不购买max，这就是问题所在", true, "a21"], ["This antimatter triggers me", true, "a22"],
["No, mom, I can't pause this game.", true, "a23"], ["科学记数法已进入战场。", true, "a24"], ["让宇宙再次伟大！ -Tronald Dump", true, "a25"], ["#dank-maymays", true, "a26"],
["A new religion has been created, and it's spreading like wildfire. The believers of this religion worship the Heavenly Pelle, the goddess of antimatter. They also believe that 10^308 is infinite.", true, "a27"], ["有人刚碰到一个团块，就爆炸了。是团反物质，还是爆炸物质?", true, "a28"],
["If you are not playing on Kongregate or ivark.github.io, the site is bootleg.", true, "a29"], ["Rate 5 on Kongregate so more people can experience this 5 star Rating", true, "a30"], ["BOO!", true, "a31"], ["你吃得太久了。-埃维佩尔", true, "a32"], ["我讨厌我自己。-Boo-chan", true, "a33"],
["Gee golly -Xandawesome", true, "a34"], ["在我们之上，没有任何东西在上面，只有星星在上面。", true, "a35"], ["If black lives matter, do white lives antimatter?", true, "a36"], ["Somebody wasn't nice, he got an antimatter-storm.", true, "a37"],
...
["如果一切都是反物质的，你怎么能看到自己？", true, "a44"], ["The stock markets have crashed due to antimatter beings somehow knowing what they will be tomorrow.", true, "a45"], ["My dog ate too much antimatter, now he is doing 'meow!'", true, "a46"], ["If you put infinity into your calculator it will result in 42!", true, "a47"],
["你找到了最稀有的反物质pepe，它是非常罕见的！", true, "a48"], ["我们可以在这个视频上获得1e169赞吗？ 像按钮一样粉碎！", true, "a49"],
["The smell of antimatter has been revealed. It smells like kittens", true, "a50"], ["只是墙上的另一个反物质", true, "a51"], ["GET SNIPED, WEAKLING", true, "a52"], ["Thanks a lot -dankesehr", true, "a53"],
...
["If you open an anti-lootbox, are you selling random possessions for in-game currency?", true, "a106"], ["人们开始质疑赫维佩尔的存在。",  true, "a107"], ["Antimatter Dimensions is proud to be sponsored by Lehmä! Now offering - grass eating lessons! Learn what grass is safe to eat and what grass isn't.",  true, "a108"],
